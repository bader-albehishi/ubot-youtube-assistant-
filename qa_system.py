# qa_system.py - Updated for OpenAI v1.0+ API
import os
import re
import logging
import time
...
def generate_prompt(question: str, context: List[str], language: str = "en", conversation_history: List[Tuple[str, str]] = None) -> str:
...
def generate_agent_prompt(question: str, context: List[str], language: str = "en", conversation_history: List[Tuple[str, str]] = None) -> str:
    """Generate a prompt for the LLM using ReAct agent approach"""
...
def ask_question(
    ...
    video_title: str = None  # New parameter
) -> str:
    """
